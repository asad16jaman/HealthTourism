                        ...
                        <div class="row">
                            <div class="col-12">
                                    <div class="">
                                        ...
                                        <textarea name="description" class="form-control" rows="6" id="description">{{ old('description',optional($editItem)->description) }}</textarea>
                                    </div>
                            </div>
                        </div>
                                            ...
                                            <table id="basic-datatables"
                                                ...
                                                @forelse($datas as $data)
                                                    <tr role="row" class="odd" >
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.service.message',['id'=>$data->id]) }}" title="Click to see Message About This Service">
                                                                <img class="tablepicture" src="{{ $data->img ? asset('storage/' . $data->img) : asset('assets/admin/img/demoProfile.png') }}" alt="user profile picture">
                                                            </a>
                                                        </td>
                                                        <td>{{ $data->name }}</td>
                                                        <td>{{ $data->title}}</td>
                                                        ...
                                                        <td class="d-flex justify-content-center">
                                                            <a href="{{ route('admin.service', ['id' => $data->id, 'page' => request()->query('page'), 'search' => request()->query('search')]) }}" class="btn btn-info p-1 me-1">
                                                                <i class="fas fa-edit iconsize"></i>
                                                            </a>
                                                            <form action="{{ route('admin.service.delete', ['id' => $data->id]) }}" method="post">
                                                                @csrf
                                   ...
                                   <div class="row">
                                        <div class="col-12 d-flex justify-content-end me-2">
                                            ...
                                            @if ($datas->nextPageUrl())
                                                <a href="{{ $datas->nextPageUrl() }}" class="btn btn-primary mx-2 p-1"><i
