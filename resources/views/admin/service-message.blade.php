...
@section('title', 'Service Message Page')
...
@section('pageside')
    @include('admin.layout.sidebar', ['page' => 's-message'])
@endsection
                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    <thead class="headbg">
                                        <tr role="row bg-dark">
                                            ...
                                            <th style="width: 400.875px;">ServiceName</th>
                                            <th style="width: 214.469px;">Name</th>
                                            <th style="width: 150.469px;">Email</th>
                                        ...
                                        @forelse($datas as $data)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="d-flex justify-content-center">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.service.message.delete', ['id' => $data->id]) }}"
                                                        method="post">
                                                        @csrf
