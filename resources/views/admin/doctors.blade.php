...
@section('pageside')
    @include('admin.layout.sidebar', ['page' => 'doctor'])
@endsection
        ...
        <div class="page-inner">
            <div class="card mb-1">
                <div class="card-header pt-1 pb-0">
                    <h4 class="text-center">Create Doctor</h4>
                </div>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        ...
                                        @enderror" name="designation" value="{{ old('designation', optional($editItem)->designation)}}"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="status" class="form-select form-select-sm" id="">
                                            @if($editItem)
                                                <option value="1" {{ optional($editItem)->status == 1 ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ optional()->status == 0 ? 'selected' : '' }}>Inactive</option>
                                            @else
                            ...
                            <div class="col-12">
                                <div class="">
                                    ...
                                    <textarea name="detail" class="form-control" rows="6"
                                        id="description">{{ old('detail', optional($editItem)->detail) }}</textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    <thead class="headbg">
                                        <tr role="row bg-dark">
                                            ...
                                            <th style="width: 104.469px;">Email</th>
                                            <th style="width: 114.469px;">Speciality</th>
                                            <th style="width: 514.469px;">Detail</th>
                                            <th style="width: 100.469px;">Status</th>
                                    ...
                                    <tbody>
                                        @forelse($datas as $data)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.service.message', ['id' => $data->id]) }}"
                                                        title="Click to see Message About This Service">
                                                        <img class="tablepicture"
                                                            src="{{ $data->img ? asset('storage/' . $data->img) : asset('assets/admin/img/demoProfile.png') }}"
                                                ...
                                                <td>{{ substr(strip_tags($data->detail), 0, 70)."..."}}</td>
                                                <td>{{ $data->status ? "Active" : "Inactive" }}</td>
                                                <td class="d-flex justify-content-center">
                                                    <a href="{{ route('admin.doctor', ['id' => $data->id, 'page' => request()->query('page'), 'search' => request()->query('search')]) }}"
                                                        class="btn btn-info p-1 me-1">
                                                        <i class="fas fa-edit iconsize"></i>
                                                    </a>
                                                    <form action="{{ route('admin.doctor.delete', ['id' => $data->id]) }}"
                                                        method="post">
                                                        @csrf
